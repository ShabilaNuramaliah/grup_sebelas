...
export default function Dashboard() {
  ...
  return (
    <main className="min-h-screen mt-3">
      {/* Pertama */}
      <section className="relative pl-20 py-16 md:py-24 bg-white">
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <button
              className="bg-black font-semibold text-white px-8 py-3 rounded-md hover:bg-gray-800 hover-scale"
              onClick={handleClick}
            >
              Sewa Sekarang
            </button>
      ...
      {/* Ketiga About */}
      <section id="About" className="py-16 px-20 bg-white">
        <div className="container mx-auto px-4">
        ...
        <div className="flex gap-10 overflow-x-auto snap-x snap-mandatory hide-scrollbar">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <p className="text-gray-600 text-md">{testimonial.review}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="Contact" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-gray-50 p-6 rounded-lg text-center hover-scale shadow-md">
              <Phone className="w-8 h-8 mb-4 mx-auto" />
              <p className="text-xl font-semibold text-center"></p>
              <p>089799699599</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg text-center shadow-md hover-scale">
